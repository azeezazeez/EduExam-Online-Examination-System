  ...
  return (
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col items-center py-12 px-4 md:px-8">
      ...
      <motion.div
        ...
        className={`w-full max-w-6xl mb-8 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl ${
          isPass
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-white/80 font-medium">
              {isPass
                ? 'You have successfully cleared the examination.'
                : 'You did not meet the minimum qualification criteria.'}
            </p>
        ...
        >
          ...
          <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100">
            ...
            <div className="mt-10 pt-8 border-t border-slate-50">
              ...
              <div className={`flex items-center justify-center gap-3 p-4 rounded-2xl font-black text-sm uppercase tracking-widest ${
                isPass
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-5 rounded-2xl font-black text-lg bg-white border-2 border-slate-100 text-slate-600 hover:bg-slate-50"
            >
